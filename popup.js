...
function drawColorSelector(target, defaultColor, colorSet) {
    ...
    for (color in colors) {
        if (colors[color] == defaultColor) {
            htmlContent += '<li class="color selected" colorValue="' + colors[color] + '" style="background-color:' + colors[color] + '; color: ' + invertColor(colors[color],true) + ';"></li>';
        }
        else {
            htmlContent += '<li class="color" colorValue="' + colors[color] + '" style="background-color:' + colors[color] + '; color: ' + invertColor(colors[color],true)+ ';"></li>';
        }
    }
    htmlContent += '</ul><input id="' + colorSet + '" class="jscolor" style="margin-left:10px;max-width:60px;" placeholder="html color code e.g. #e5e5e5" value="' + defaultColor + '">';
